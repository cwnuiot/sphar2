...
import pickle
if os.path.isfile("suiji_model2.pkl"):
    svm = pickle.load(open("suiji_model2.pkl", "rb"))
else:
    svm = RandomForestClassifier(random_state=0, n_jobs=-1)
    svm.fit(traindata, trainlabel)
    pickle.dump(svm, open("suiji_model2.pkl", "wb"))
